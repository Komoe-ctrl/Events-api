...
import { CategorieEvenement, StatutEvenement } from '../../../generated/prisma/client';
...
export class EvenementPublicDto {
  ...
  @ApiPropertyOptional({ nullable: true, type: Number }) capacite!: number | null;
  @ApiProperty() latitude!: number;
  @ApiProperty() longitude!: number;
  @ApiProperty() adresse!: string;
  @ApiProperty() commune!: string;
  @ApiProperty({ enum: StatutEvenement }) statut!: StatutEvenement;
  @ApiPropertyOptional({ nullable: true, type: String }) motifRefus!: string | null;
  @ApiProperty() organisateurId!: string;
  @ApiProperty() contactOrganisateur!: string;
  @ApiProperty() createdAt!: Date;
  @ApiProperty() updatedAt!: Date;

  @ApiPropertyOptional({ description: 'Present uniquement si lat/lng fournis a la recherche' })
  distanceKm?: number;
}
